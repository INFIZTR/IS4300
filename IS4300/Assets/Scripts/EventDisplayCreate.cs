...
public class EventDisplayCreate : MonoBehaviour
{
    ...
    void DisplayEvents()
    {
        ...
        foreach (var eventSO in eventList.myCreatedEvents)
        {
    ...
    void RemoveEvent(EventData eventSO, GameObject button)
    {
        ...
        if (eventList.myCreatedEvents.Contains(eventSO))
        {
            eventList.myCreatedEvents.Remove(eventSO);
